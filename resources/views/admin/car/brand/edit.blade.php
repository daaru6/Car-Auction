                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div>
                                        ...
                                        <form
                                            action="{{ route('admin.car.brand.edit', ['id'=>$data['edit_category']['brand_id']]) }}"
                                            method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text"
                                                    ...
                                                    value="{{ $data['edit_category']['brand_name'] }}"
                                                    name="brand_name">
                                    ...
                                    @forelse ($data['all_brands'] as $brand)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.car.brand.del', ['id'=> $brand->brand_id]) }}"

                                                    class="delete btn btn-danger waves-effect waves-light btn-md"
