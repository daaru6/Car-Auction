                ...
                <div class="col-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <h4 class="card-title">Edit Car Category</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div>
                                        ...
                                        <form
                                            action="{{ route('admin.car.category.edit', ['id'=>$data['edit_category']['category_id']]) }}"
                                            method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text"
                                                    ...
                                                    value="{{ $data['edit_category']['category_name'] }}"
                                                    name="category_name">
                                    ...
                                    @forelse ($data['all_category'] as $category)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('admin.car.category.del', ['id'=> $category->category_id]) }}"
