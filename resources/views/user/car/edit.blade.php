                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('user.car.edit', ['id' => $data['edit']['car_id']]) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter Your Car name"
                                            value="{{ $data['edit']['car_name'] }}" name="car_name">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{ $data['edit']['price'] }}" name="price"
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select name="category_id" class="form-control" id="basicpill-category-id-input"
                                            ...
                                            @forelse ($data['all_category'] as $category)
                                                @if ($data['edit']['category']['category_id'] === $category->category_id)
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select name="brand_id" class="form-control" id="basicpill-category-id-input"
                                            ...
                                            @forelse ($data['all_brands'] as $brand)
                                                @if ($data['edit']['brand']['brand_id'] === $brand->brand_id)
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <select name="car_type" class="form-control" id="basicpill-category-id-input"
                                            ...
                                            <option {{ $data['edit']['car_type'] === 0 ? 'selected' : '' }}
                                                value="0">Manual</option>
                                            <option {{ $data['edit']['car_type'] === 1 ? 'selected' : '' }}
                                                value="1">Automatic</option>
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input class="form-control" type="date" value="{{$data['edit']['expiry_date']}}"   name="expiry_date"  id="example-date-input">
                               
                                    </div>
                                    <div class="col-lg-12 mb-3">

                                        <label for="basicpill-category-id-input" class="form-label">Description</label>
                                        <textarea class="form-control" name="description" cols="30" rows="5">{{ $data['edit']['description'] }}</textarea>
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <input class="form-control" type="file" id="input-image" accept="image/*"
                                            placeholder="Enter Your Car name" value="" name="image">

                                    </div>
                                    <div id="preview" class="col-lg-8 mb-3">
                                        <img src="{{ asset('upload/' . $data['edit']['image']) }}" alt=""
                                            width="200px">
                                    </div>
                                    ...
                                    <div class="col-lg-4 mb-3">
                                        ...
                                        <label for="basicpill-category-id-input" class="form-label">Gallery
                                            Images</label>
                                        <input class="form-control" type="file" id="input-images"
                                            multiple="multiple" accept="image/*" placeholder="Enter Your Car name"
                                            value="" name="additional_images[]">

                                    </div>
                                    <div id="previewMulti" class="col-lg-12 mb-3 row">
                                        @foreach ($data['edit']['gallery'] as $image)
                                            <div class="preview-item col-md-3 m-1">
                                                <img width="200px" src="{{ asset('upload/' . $image['image']) }}"
                                                    alt="Gallery Image">
                                                  
                                                <a href="{{ route('user.car.gallery.del', ['id'=> $image['car_gallery_id']]) }}"class="delete btn btn-danger waves-effect waves-light btn-md"
